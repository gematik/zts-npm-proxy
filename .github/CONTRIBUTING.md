...
Please do not report vulnerabilities and security incidents as GitHub issues. Please contact us by sending an E-Mail to [ZTS Contact Address](mailto:zts@gematik.de?subject=[GitHub]%20zts-npm-proxy) or report them using the contact form at https://fachportal.gematik.de/kontaktformular.
